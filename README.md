About ffnvcodec-headers-feedstock
=================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ffnvcodec-headers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ffnvcodec-headers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ffnvcodec-headers
# for installing globally
pixi global install ffnvcodec-headers
```
...
It is possible to list all of the versions of `ffnvcodec-headers` available on your platform:
...
```
pixi search ffnvcodec-headers --channel conda-forge
```
